            ...
            <div class="choosed-lang">
                <form class="form-selected-lang">
                    <select id="language" name="language" onchange="submit()">
                        ...
                        <option value="be_BY" ${language == 'be_BY' ? 'selected' : ''}>Belarussian</option>
                    </select>
                </form>
            </div>
            <div class="wrap-login p-l-50 p-r-50 p-t-77 p-b-30">
                <form name="loginForm" enctype="multipart/form-data" method="POST" action="controller" class="login-form validate-form">
                    ...
                    <div class="sys-error">
                        ...
                        <p>${requestScope.wrongAction}</p>
                        <p>${requestScope.nullPage}</p>
                        <p>${requestScope.unknownUser}</p>
                    </div>
                ...
                <div class="go-to-register">
                    ...
                    <a href="<c:url value="/controller?command=goToRegister"/>">${registerValue}</a>
                </div>
            </div>
        </div>
    </div>
