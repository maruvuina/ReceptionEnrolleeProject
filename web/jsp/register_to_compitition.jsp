            ...
            <div class="school-subjects">
                <div class="row">
                    ...
                    <div class="right-column">
                        <input id="lang_bel" required type="text" name="lang_bel" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="right-column">
                        <input id="lang_bel_lit" required type="text" name="lang_bel_lit" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="lang_rus" required type="text" name="lang_rus" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="lang_rus_lit" required type="text" name="lang_rus_lit" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="foreign_lang" required type="text" name="foreign_lang" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="maths" required type="text" name="maths" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="informatics" required type="text" name="informatics" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="bel_his" required type="text" name="bel_his" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="world_his" required type="text" name="world_his" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="social_science" required type="text" name="social_science" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="geo_sub" required type="text" name="geo_sub" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="bio_sub" required type="text" name="bio_sub" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="phys_sub" required type="text" name="phys_sub" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="astro" required type="text" name="astro" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="chem" required type="text" name="chem" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="left-column">
                    ...
                    <div class="right-column">
                        <input id="training" required type="text" name="training" value="" placeholder="<fmt:message key="register.page.placeholder.mark"/>"/>
                    </div>
                </div>
            </div>
        </fieldset>
